...
bool e_elements::begin_child_ex(const char* name, ImGuiID id, const ImVec2& size_arg, bool border, ImGuiWindowFlags flags)
{
    ...
    parent_window->DrawList->AddRectFilledMultiColorRounded(parent_window->DC.CursorPos, parent_window->DC.CursorPos + ImVec2(size.x - 115, 32), ImColor(24, 24, 26), ImColor(147, 190, 66, 50), ImColor(232.00000137091, 163.00000548363, 33.000001832843, 0), ImColor(232.00000137091, 163.00000548363, 33.000001832843, 0), ImColor(232.00000137091, 163.00000548363, 33.000001832843, 50), 4.0f, ImDrawCornerFlags_TopLeft);
    parent_window->DrawList->AddText(bold, 15.0f, parent_window->DC.CursorPos + ImVec2(16, 9), ImColor(232, 163, 33), name);
