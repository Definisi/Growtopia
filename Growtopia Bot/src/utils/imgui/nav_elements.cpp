...
bool elements::tab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 4, rect.Min.y + 6), ImVec2(rect.Max.x + 8, rect.Max.y - 6), ImColor(0.9098039269447327f, 0.6392157077789307f, 0.1294117718935013f, it_anim->second.rect_opacity), 7.0f, ImDrawFlags_RoundCornersLeft);
...
bool elements::subtab(const char* name, bool boolean)
{
    ...
    window->DrawList->AddRectFilled(ImVec2(rect.Max.x + 5, rect.Min.y + 9), ImVec2(rect.Max.x + 8, rect.Max.y - 9), ImColor(0.9098039269447327f, 0.6392157077789307f, 0.1294117718935013f, it_anim->second.rect_opacity), 10.0f, ImDrawFlags_RoundCornersLeft);
